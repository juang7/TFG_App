...
public class AnadirAlergiaPersona extends AppCompatActivity {

    private Button bAñadir;
    private TextView texto;
    private EditText id_p;
    private EditText id_a;
    private static final int NOTIF_ALERTA_ID = 1;

    private class LongRunningGetIO extends AsyncTask<Void, Void, String> {
        String s_id_p = id_p.getText().toString();
        String s_id = id_a.getText().toString();
        ...
        protected String doInBackground(Void... params) {
            ...
            try{
               //JSONObject respJSON = new JSONObject("{\"_id\":"+s_id+",\"descripcion\":\""+s_name+"\"}");
                URL urlToRequest = new URL("http://192.168.1.17:8080/user/addAlergia/"+s_id_p+"/"+s_id);
        ...
        protected void onPostExecute(String results) {
            ...
            NotificationCompat.Builder notificacion =
                    new NotificationCompat.Builder(AnadirAlergiaPersona.this)
            ...
            Intent notIntent = new Intent(AnadirAlergiaPersona.this, MembersActivity.class);
            PendingIntent contIntent =
                    PendingIntent.getActivity(AnadirAlergiaPersona.this,0, notIntent,
                            0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_alergia_persona);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.home:
                Intent intentHome = new Intent(AnadirAlergiaPersona.this, MainActivity.class);
                startActivity(intentHome);
                return true;
            case R.id.members:
                Intent intentMiembros = new Intent(AnadirAlergiaPersona.this, MembersActivity.class);
                startActivity(intentMiembros);
                return true;
            case R.id.deletegroup:
                Intent intentDeleteGroup = new Intent(AnadirAlergiaPersona.this, DeleteGroupActivity.class);
                startActivity(intentDeleteGroup);
                return true;
            case R.id.dblp:
                Intent intentDBLP = new Intent(AnadirAlergiaPersona.this, DBLPActivity.class);
                startActivity(intentDBLP);
                return true;
            case R.id.newmember:
                Intent intentNewMember = new Intent(AnadirAlergiaPersona.this, NewMemberActivity.class);
                startActivity(intentNewMember);
                return true;
            case R.id.newalergia:
                Intent intentNewAlergia = new Intent(AnadirAlergiaPersona.this, NewAlergia.class);
                startActivity(intentNewAlergia);
                return true;
            case R.id.alergia:
                Intent intentMostrarAlergia = new Intent(AnadirAlergiaPersona.this, MostrarAlergia.class);
                startActivity(intentMostrarAlergia);
                return true;
            case R.id.alergiaPersona:
                Intent intentAlergiaPersona = new Intent(AnadirAlergiaPersona.this, MostrarAlergiaPersona.class);
                startActivity(intentAlergiaPersona);
                return true;
            case R.id.anadirAlergiaPersona:
                Intent intentañadirAlergiaPersona = new Intent(AnadirAlergiaPersona.this, AnadirAlergiaPersona.class);
